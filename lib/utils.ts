...
export const SERVICES = [
  ...
  // Technology & AI
  {
    ...
    description: "High-converting websites, e-commerce stores, landing pages, and custom web or mobile apps — built for performance and results.",
    icon: "Code",
    color: "#F43F5E",
  ...
  },
  {
    ...
    description: "Optimized cloud architecture, cost engineering, and migration planning across AWS, GCP, and Azure — designed for performance and savings.",
    icon: "Cloud",
    color: "#38BDF8",
    category: "Technology & AI",
    price: "Custom Quote",
